...
namespace anbardari.Controllers
{
    public class categoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,anbarId,subject,active")] tbl_category tbl_category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,anbarId,subject,active")] tbl_category tbl_category)
        {
            if (ModelState.IsValid)
            {
